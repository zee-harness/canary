...
type ResilienceNav = 'overview' | 'insights' | 'chaos-experiments' | 'usage' | 'load-tests' | 'dr-tests' | 'settings'
    ...
    <Sidebar.Content>
      ...
      <Sidebar.Group label="Recent">
        <Sidebar.Item icon="chaos-tests" title="Resilience Tests" defaultSubmenuOpen>
          ...
          />
          <Sidebar.MenuSubItem
            to="/view-preview/resilience-tests/dr-tests"
            end
            active={activeNav === 'dr-tests'}
            title="DR Tests"
          />
          <Sidebar.MenuSubItem to="/view-preview/resilience-tests/usage" title="Resilience Test Usage" />
          <Sidebar.MenuSubItem
            to="/view-preview/resilience-tests/settings"
            end
      ...
      breadcrumbs={
        ...
        >
          <Breadcrumb.Root className="select-none">
            <Breadcrumb.List>
              <Breadcrumb.Item>
                {isChaos || isUsage || isInsights || isLoadTests || isDrTests || isSettings ? (
                  <Breadcrumb.Link href="#">
                    {isInsights || isLoadTests || isDrTests || isSettings ? 'Resilience Tests' : 'Resilience Testing'}
                  </Breadcrumb.Link>
                ) : (
              ...
              {isDrTests && (
                <>
                  <Breadcrumb.Separator />
                  <Breadcrumb.Item>
                    <Breadcrumb.Page>DR Tests</Breadcrumb.Page>
                  </Breadcrumb.Item>
                </>
              )}
              {isLoadTests && (
